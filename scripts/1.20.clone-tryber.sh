...
if [ -d ~/dev/tryber/tryber-react ]; then
    ...
    git clone git@github.com:AppQuality/tyber-react.git ~/dev/tryber/tryber-api
fi
...
if [ -d ~/dev/tryber/tryber-backoffice ]; then
    ...
    git clone git@github.com:AppQuality/tyber-backoffice.git ~/dev/tryber/tryber-api
fi