...
if [ -d ~/dev/tryber/tryber-api ]; then
    ...
    git clone git@github.com:AppQuality/tryber-api.git ~/dev/tryber/tryber-api
fi
...
if [ -d ~/dev/tryber/tryber-react ]; then
    ...
    git clone git@github.com:AppQuality/tryber-react.git ~/dev/tryber/tryber-react
fi
...
if [ -d ~/dev/tryber/tryber-backoffice ]; then
    ...
    git clone git@github.com:AppQuality/tryber-backoffice.git ~/dev/tryber/tryber-backoffice
fi